...
export interface GovernorCharlieEventsInterface extends utils.Interface {
  functions: {};
...
export interface GovernorCharlieEvents extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GovernorCharlieEventsInterface;
