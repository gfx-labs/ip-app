...
export interface IGovernorCharlieDelegatorInterface extends utils.Interface {
  functions: {
...
export interface IGovernorCharlieDelegator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IGovernorCharlieDelegatorInterface;
