...
import type {
  ...
  export interface CappedRebaseTokenInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(
      functionFragment: "initialize(string,string,address,address)",
      values: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
        PromiseOrValue<string>,
    ...
    encodeFunctionData(
      functionFragment: "underlyingToWrapper(uint256)",
      values: [PromiseOrValue<BigNumberish>]
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
      functionFragment: "wrapperToUnderlying(uint256)",
      values: [PromiseOrValue<BigNumberish>]
    ): string;
  ...
  export interface CappedRebaseToken extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
  
    interface: CappedRebaseTokenInterface;
    ...
    functions: {
      ...
      wrapperToUnderlying(
        cappedAmount: PromiseOrValue<BigNumberish>,
        overrides?: CallOverrides
      ): Promise<[BigNumber]>;
