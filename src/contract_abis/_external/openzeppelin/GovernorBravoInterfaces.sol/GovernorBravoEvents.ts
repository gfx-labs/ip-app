...
export interface GovernorBravoEventsInterface extends utils.Interface {
  ...
  events: {
    ...
    "ProposalCanceled(uint96)": EventFragment;
    "ProposalCreated(uint96,address,address[],uint256[],string[],bytes[],uint256,uint256,string)": EventFragment;
    "ProposalExecuted(uint96)": EventFragment;
    "ProposalQueued(uint96,uint256)": EventFragment;
...
export interface GovernorBravoEvents extends BaseContract {
  ...
  filters: {
    ...
    "ProposalCanceled(uint96)"(id?: null): ProposalCanceledEventFilter;
    ProposalCanceled(id?: null): ProposalCanceledEventFilter;

    "ProposalCreated(uint96,address,address[],uint256[],string[],bytes[],uint256,uint256,string)"(
      id?: null,
      proposer?: null,
      targets?: null,
      values?: null,
    ...
    "ProposalExecuted(uint96)"(id?: null): ProposalExecutedEventFilter;
    ProposalExecuted(id?: null): ProposalExecutedEventFilter;

    "ProposalQueued(uint96,uint256)"(
      id?: null,
      eta?: null
