...
export interface CappedMkrTokenInterface extends utils.Interface {
  functions: {
...
export interface CappedMkrToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CappedMkrTokenInterface;
  ...
  functions: {
    ...
    initialize(
      ...
      mkrVotingVaultController_: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
