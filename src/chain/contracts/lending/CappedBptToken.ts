...
export interface CappedBptTokenInterface extends utils.Interface {
  functions: {
    ...
    "deposit(uint256,uint96,bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "deposit(uint256,uint96,bool)",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<boolean>
  ...
  events: {
    ...
    "cappedBPTtransfer(uint96,address,uint256)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "cappedBPTtransfer"): EventFragment;
  getEvent(
    nameOrSignatureOrTopic: "cappedBPTtransfer(uint96,address,uint256)"
  ): EventFragment;
}
...
export interface cappedBPTtransferEventObject {
  vaultId: BigNumber;
  recipient: string;
  amount: BigNumber;
}
export type cappedBPTtransferEvent = TypedEvent<
  [BigNumber, string, BigNumber],
  cappedBPTtransferEventObject
>;

export type cappedBPTtransferEventFilter =
  TypedEventFilter<cappedBPTtransferEvent>;

export interface CappedBptToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CappedBptTokenInterface;
  ...
  filters: {
    ...
    "cappedBPTtransfer(uint96,address,uint256)"(
      vaultId?: null,
      recipient?: null,
      amount?: null
    ): cappedBPTtransferEventFilter;
    cappedBPTtransfer(
      vaultId?: null,
      recipient?: null,
      amount?: null
