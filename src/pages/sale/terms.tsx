...
Welcome to https://interestprotocol.io, a user interface (the “Interface”) provided by GFX Labs, Inc. (“we,” “our,” or “us”). The Interface allows access to a decentralized protocol that allows users to borrow and lend stablecoins on the Ethereum and Ethereum-compatible blockchains. ("Interest Protocol" or the "Protocol").
...
You expressly agree that you assume all risks in connection with your access and use of the Interface and your interaction with the Protocol, including (but not limited to):
...
Digital Asset and Transaction Fee Volatility. You understand that Ethereum, other blockchain technologies, associated digital assets, and the markets for those digital assets are highly volatile due to factors including (but not limited to) adoption, speculation, technology, regulation, and security. You also acknowledge that the cost of transacting on such technologies—commonly called “gas”—is variable and may increase, causing an impact on the cost of activities taking place on the Ethereum blockchain. You acknowledge these risks and represent that we cannot be held liable for such fluctuations or increased costs. 
...
USDC Value Diverging from USD Risk. You understand that USDi is pegged to USD via USDC. If the price of USDC diverges from that of USD, the price of USDi can also diverge from USD. The Protocol's oracles system relies on both USDC and USD-denominated prices. Therefore, if USDC’s price diverges from USD, the oracle system's safeguard will activate and prevent users from using certain Protocol functionalities. You acknowledge and understand this risk and that we are not responsible for any USDC depeg and cannot be held liable for any resulting losses or lack of access to the Protocol.

Applicable Law and Tax. You are responsible for complying with applicable law. You agree that we are not responsible for determining which laws may apply to your use of the Interface and Protocol, including tax laws. You are solely responsible for reporting and paying any taxes arising from your use of the Interface and Protocol.

General Risk of Regulatory Actions in One or More Jurisdictions. You acknowledge that the Interface, the Protocol, USDi, IPT, and digital assets generally could be impacted by one or more regulatory inquiries or regulatory action, which could impede or limit your ability to access or use the Interface, the Protocol, or the Ethereum blockchain, including access to your Digital Assets or other funds.
