...
export const ProtocolStatsCard = () => {
  ...
  return (
    <Box sx={{
      padding: 6,
      backgroundImage: `linear-gradient(${formatGradient(isLight ? gradient.gradient1 : gradient.gradient2)})`,
      borderRadius: 17
    }}>
      <Box
        about="Minted and Deposited stats"
        sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", columnGap: 2, marginBottom: 4 }}
      >
      ...
      <Box sx={{display: 'flex', justifyContent: 'flex-end', marginTop: 2}}>
        <Box component="img" src="images/ReserveRatio.png" width={17} height={18} marginRight={1}/>
