...
The function has two kinks, at (s_1,r_1) and (s_2,r_2). The interval [s1,s2] is the range of reserve ratios that the protocol targets. The current parameters are provided in the table below.
