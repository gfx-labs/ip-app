...
* GovernorDelegate: is the implementation governance contract. 
* GovernorDelegator: is the base governance contract that references the implementation for the core logic.

## Token Contracts
* TokenDelegate: is the implementation token contract.
* TokenDelegator: is the base token contract that references the implementation for the core logic.
